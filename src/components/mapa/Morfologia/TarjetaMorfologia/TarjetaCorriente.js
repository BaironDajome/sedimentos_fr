...
import Tarjeta_Informacion_Corriente from "./Tarjeta_Informacion_Corriente";
...
export default function TarjetaCorriente({ view, puertos = [], onPuertoChange, basemapRef }) {
  ...
  return (
    <calcite-shell-panel slot="panel-end" display-mode="float">
      <calcite-panel heading="Capas y Corrientes">
        ...
        <Tarjeta_Informacion_Corriente view={view} />
      </calcite-panel>
    </calcite-shell-panel>
  );
}
